...
\subtitle{\small{Drafted  3rd October 2014 \\
          Extended 14th Jan 2018 by section on g.a.t. of contextual categories (incomplete)\\
					Minor Corrections 13th Oct 2021 -- mathematical typo plus corrections and improvements to diagram}\\
					Minor improvements including fixes to diagrams 03 Sept 2022}
\date{}
...
However, contextual categories contain structure that is in some sense redundant; this is in the same way that a Lawvere algebraic theory contains redundant structure compared to the otherwise equivalent notion, from universal algebra, of an abstract clone (see, for example, \cite{KerkoffonClones}). In both cases the redundancy is introduced in order to achieve structures which are explicitly categories of some kind with additional structure. 
...
\input{crossstardistributivityaxiom}
		   ...
		   \flexbranch{Ly}{1cm}{1.4cm}{y}{m} {}
       {
		...
		\flexbranch{Lfy}{1.2cm}{2.2cm}{f \sub y}{m}{}
	 	{  
		   ...
		   \Tr{\Rnode{xxx}{f \sub(y \cross y)}} \member{f \sub \diag_{y}}
		   ...
		   {\Tr{x}}
			 {
			   \flexbranchinitialarc{Lxym}{1.7cm}{1cm}{x \cross y}{m}{}{\Tr{x \cross y}}{1}{\upperaccutemember{f_1}}
				 ...
				 \Tr{f_{m} \sub ...  f_2 \sub f_1 \sub (x \cross y)}{\loweraccutemember{f}}
			 }
		 }		  
