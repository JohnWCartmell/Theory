...
\begin{center}
\scalebox{0.75}{\input{../content/cricketMatch.logical}}
\end{center}
\end{frame}
...
\begin{tabular}{l l}
\raisebox{-1.9cm}{\scalebox{0.75}{\input{../content/cricketMatch.relational}} }
& \kern-3cm\onslide*<1-1>{\logicalAnnotation}\onslide*<2-2>{\logicalWithScopesAnnotation}  \onslide*<3-3>{\hierarchicalAnnotation}\onslide*<4-4>{\relationalAnnotation}
\end{tabular}
\end{frame}
