...
If in any of these four cases it is known in addition that that the map is injective then the crowsfoot is omitted and so the relationship is depicted by a line which may be dashed or half dashed. The possibilities are:
\begin{center}
