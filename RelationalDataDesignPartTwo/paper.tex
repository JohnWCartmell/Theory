...
\commentary{Describe that more general relationships are simplified to functional relationships i.e.many-many n-place simplified to many-one binary relationships}
