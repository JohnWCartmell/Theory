...
yield jointly injective sets when composed. \commentary{Do a better job of this proof.}
\end{proof}
...
\begin{lemma}
In a model M if $Q$ a set of identifying paths from entity type $a$ to $v$
and if every such identifying path is equivalent to a path in $Q$ then
