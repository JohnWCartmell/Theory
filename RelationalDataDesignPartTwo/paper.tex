...
Before we commence the theory we give one further example. It is an example that puts paid to the idea that 
identifying relationships and equivalence of paths can replace primary keys in the definition of an ER model. 
The example is shown in figure \ref{} and identifying relationships and attributes and shown. In this example there is
