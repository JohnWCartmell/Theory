...
Examples\footnote{These two next diagrams need their `.tex' regenerating to get updated fontsizes.}

\begin{center}
\scalebox{0.5}{
\input{\erpictureFolder/relationalForeignKeyColumnToScope.tex}
}
\end{center}
\begin{center}
\scalebox{1.0}{
\input{\erpictureFolder/relationalForeignKeyColumnToScope2.tex}
}
\end{center}
