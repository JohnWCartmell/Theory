...
set $j$ paths sourced at $b$, $j \in \bar{I}$, such that $I_a \simeq h \cup {f\circ g}{g \in j}$.
...
an edge $k$ added, $k:a \morph b$, each database instance $E$ extended $E_k = E_f$.
...
\begin{definition}
If \genericmodel\ can be factored  
\end{definition}
