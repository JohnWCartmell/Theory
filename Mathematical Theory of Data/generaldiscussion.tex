...
Since $Hom_{\catc}(a,-): \catc \morph \Fin$ is an instance of $\catc$ \commentary{Problem hom sets may not be finite!!} and since $\catc$ is maximally constrained there is a functor $F': C' \morph \Fin$
