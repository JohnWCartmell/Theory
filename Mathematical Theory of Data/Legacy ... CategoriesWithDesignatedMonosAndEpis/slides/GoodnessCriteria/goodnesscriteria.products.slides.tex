...
is written  \msfd{x_1,...x_n}{y} in relational data theory.
\item This is the notation used in the usual definition of BCNF.
\item The definition is such that in the category \catcw with products \msfd{x_1,...x_n}{y} iff $\fundep{}{\tuple{x_1,...x_n}}{y}$.
\end{itemize}
\end{frame}
...
are edges of $S$
and if \msfd{x_1,...x_n}{y}  is a non-trivial functional dependency  then
