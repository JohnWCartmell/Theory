...
\begin{newtt}
Instead I have concept of an RR.5 range category.
\end{newtt}
...
\begin{newtt}
I think that we know from J.R.B. COCKETT, XIUZHAN GUO AND PIETER HOFSTRA that this is the same as an RR.5 range category.
\end{newtt}
\end{oldtt}