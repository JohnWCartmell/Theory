...
$\reallywidehat{\rst{f_n} \circ f'_{n-1}} \circ \widehat{t_{n-1}}$ 
and that therefore  it
can be paraphrased as
\[
t_{n-1} \leq \reallywidehat{\rst{f_n} \circ f'_{n-1}}.
\]
...
Identity (\ref{tightnessIdentityTwo}) holds because both sides  simplify, using RR.3, and R.2, to $\rst{f'_{n-1} \circ \widehat{t_{n-1}}} \circ \rst{f_n}$.
...
z'_{n-1} &= \rst{z'_{n-1}} \circ z'_{n-1}  \circ \widehat{z'_{n-1}} 
         ...
         &\leq \rst{f_n} \circ f'_{n-1}  \circ \widehat{z_{n-1}}
...
\]
\begin{aside}
A useful adjunction to this us:
\[
