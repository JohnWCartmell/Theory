...
then we can extract from  ???? the following
\begin{observation}
...
\begin{enumerate}[(i)]
\item 
$\tighten{\shorten{Z}{s}{i}} = \tuple{z_1 \circ \rng{z'_1} \circ s }
                             =\shorten{\tighten{Z}}{s}{i}
$
\item 
...
\end{enumerate}
\begin{proof}
From  lemma \lref{howToTighteningaZigZagOfLengthTwo}
the tightening $\tighten{Z}$ is the zigzag
$\tuple{ \tighteningOne,\,\tighteningTwo,\,\tighteningThree}$.
Therefore from observation \lref{shorteningATightZigzagObservation}
it follows that the shortening $\shorten{\tighten{Z}}{s}{i}$
is the singleton zigzag $\tighteningOne \circ s$.
\begin{enumerate}[(i)]
\item
\begin{align*}
\shorten{\tighten{Z}}{s}{i}    
