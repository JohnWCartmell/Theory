...
\commentary{You might think this is interesting in its own right though?}
...
\commentary{What proof did I originally have in mind?}
...
and if the final morphism $f_n$ of $F$ composes with some morphism $g$
 ...
 \commentary{wobble here 
 \iffalse
 \highlight{only if} 
 $\rst{f_n \circ g} = \rst{f_n}$ \highlight{!!!}
 \highlight{or at least} $\rst{t_n \circ g} = \rst{t_n}$
\highlight{is this the same as}
$\rng{\tighten{F}} \leq \rst{g}$.
\fi
 }
