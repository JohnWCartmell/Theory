...
\tighten{\shorten{F}{s}{i}} 
    ...
    &= P_1 \circ P_2 \circ P_3
       && \mbox{\parbox[t]{7cm}
            {
          by lemma \lref{howToTightenAThreefoldConcatenationTwo},
   ...
   &= \shorten{Q_1 \cnc Q_2 \cnc Q_3}{s}{i} 
    ...
    &= \shorten{Q_1 \cnc Q_2 \cnctail Q_3}{s}{i} 
        && \mbox{\parbox[t]{7cm}
            ...
            by lemma 
                  \lref{howToTightenAThreefoldConcatenationTwo}
            $\rng{Q_2} = \rst{Q_3}$ and because the initial element of $Q_3$ is a restriction idempotent since the initial element of $R$ is. 
            }
                }  \\
...
which follows because by lemma \lref{lemmaOfThe6thOfJuly}(i):
\[
