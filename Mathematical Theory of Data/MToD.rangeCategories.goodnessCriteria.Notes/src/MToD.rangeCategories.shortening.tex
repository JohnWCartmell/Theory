...
what used to follows
 by lemma \lref{associativitySublemma} now follows by a corollary
 to the lemma \lref{lemmaOfThe6thOfJuly} that 
...
F \circ (G \circ H)
  ...
  &= shorten (T(F::T(G::H))) && \mbox{by lemma \lref{deferredShorteningLemma} (i),} \\
  &= shorten (T(F::G::H))    && \mbox{\parbox[t]{5cm}{see proof of associativity of composition of tight zigzags, section \lref{categorytightzigzags}.}}
\end{align*}  
