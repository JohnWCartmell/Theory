...
in Cockett \cite{COCKETT2012}. In summary a category with support is very much like a restriction category. It has an operator  \barItself for which R.1, R.2 and R.3 hold but for which R.4 does not necessarily hold. Instead the following
