...
The purpose of data specifications is to describe how particulars arising in some context or discursive domain
...
It formulates both fundamental principles and individual criteria for goodness of data specifications and aims to establish these by demonstrating a chain of mathematically provable logical implications \commentary{update from preparation paper}
\[
...
In this way, the fundamental principles provide both an explanation for the classic normal forms and also a basis for generalising them beyond the relational sphere in which they were first formulated.
...
To achieve good data specifications for a subject domain, the effects of any such equivalent paths must be taken into account. 
...
a data specification must be a sketch of some kind of categorical structure, 
and that it is the use of the language of category theory that enables us to precisely articulate 
the principles and criteria of goodness and to demonstrate their relationship.
