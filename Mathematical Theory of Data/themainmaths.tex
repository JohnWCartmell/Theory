...
leafprimarymonosourcerepresentativeofpka
\begin{lemma}
\label{leafprimarymonosourcerepresentativeofpka}
...
isospreserverepresentativesets
\begin{lemma}
\label{isospreserverepresentativesets}
...
injectiveisosreflectrepresentativesets
\begin{lemma}
\label{injectiveisosreflectrepresentativesets}
...
representativecontainmentlemma
\begin{lemma}
\label{representativecontainmentlemma}
...
injectiveisospreserveandreflectminimality
\begin{lemma}
...
anisoreflectsprimariesthenitsinversepreservesthem
\begin{lemma}
\commentary{Unused} %\label{anisoreflectsprimariesthenitsinversepreservesthem} 
If $\varphi: \gmodel \morph \gmodel'$ is an isomorphism of ER models  then
...
aninjectiveisoreflectsprimariesifitsinversepreservesthem
\begin{lemma}
\commentary{Unused} %\label{anisoreflectsprimariesthenitsinversepreservesthem} 
