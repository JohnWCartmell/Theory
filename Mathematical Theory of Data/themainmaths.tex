...
As described in section \lref{rkaconstruction}, the transformation (\label{firstcuttransformation} can be improved to by taking note of equivalent relationship key paths and
