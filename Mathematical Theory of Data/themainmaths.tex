...
and equivalence of sets of paths is transitive. \commentary{Do I need spell thuis out further?}
\end{proof}
...
Further if there are no proper subsets of $\setsuchthat{\phip}{p\in P}$ which are mono-sources in $\gmodel'$ and which are not representative of $\setsuchthat{\phip}{p\in P}$ then there are no proper subsets of $P$ which are mono-sources in $\gmodel$ and which are not representative of $P$.
...
The further point, that absence from $\gmodel'$ of mono-sources which are non-representative proper subsets of $\setsuchthat{\phip}{p\in P}$
...
and from the fact that a mapping $\varphi:\gmodel \morph \gmodel'$ preserves equivalence of paths
(lemma \ref{mappingrespectsequivalence})and therefore preserves equivalent sets of paths.\commentary{say more?}
...
$P$ is a mono-source in $\gmodel$
iff 
$\setsuchthat{\phip}{p\in P}$ is a mono-source in $\gmodel'$. 
Further  $P$ a leaf mono-source in $\gmodel$ iff $\setsuchthat{\phip}{p\in P}$ is a leaf mono source in $\gmodel'$ and $P$ a leaf primary mono-source in $\gmodel$ iff $\setsuchthat{\phip}{p\in P}$ is a leaf primary mono source in $\gmodel'$.
Further there are no proper subsets of $P$ which are mono-sources in $\gmodel$ and which are not representative of $P$
iff there are no proper subsets of $\setsuchthat{\phip}{p\in P}$ which are mono-sources in $\gmodel'$ and which are not representative of $\setsuchthat{\phip}{p\in P}$.
\end{lemma}
\begin{proof}
...
certainisomorphismspreservewellforulated
\begin{lemma}
\label{certainisomorphismspreservewellforulated}
...
\begin{enumerate} [(i)]
\item{
That $\gmodel'$ satisfies the minimality condition (see section \ref{minimalitycondition}) follows from lemma \ref{isospreserveandreflectmonosources}.
}
\item{ 
...
by the isomorphism $\varphi$ because $\varphi$ is assumed to reflect primary mono-sources (lemma \ref{isospreserveandreflectreferentialincds}) and then that representation of a referential inclusion dependencies by a path is  preserved by isomorphisms (lemma \ref{isospreserveandreflectrepresentationsofincds}).\commentary{Spell this out sometime??}
}
\item{ 
...
\end{lemma}
\begin{proof}
Use lemmas \ref{chiisacertaintypeofisomorphism} and \ref{certainisomorphismspreservewellforulated}.
\end{proof}
