...
If $\gmodel$ and $\gmodel'$ are ER models and  if  $\varphi$ is a \colorbox{yellow}{\sout{key-realising}} isomorphism between $\gmodel$  and $\gmodel'$ that preserves relationships\footnote{meaning that it maps relationships to relationships} and reflects primary mono-sources then if $\gmodel$ is well-formulated then $\gmodel'$ is well-formulated.
\end{lemma}
\begin{proof}
...
by $\varphi$  because $\varphi$ is assumed to \colorbox{yellow}{\sout{reflect primary mono-sources and}} preserve relationships.
...
If $\gmodel$ is $\chit$-suitable  then $\chigmodel$ there is a \colorbox{yellow}{\sout{key-realising}} 
relationship preserving  isomorphism $I_\gmodel: \gmodel \morph \chigmodel$ that \colorbox{yellow}{reflects primary mono-sources}????????.
\end{lemma}
\begin{proof}
