...
\begin{definition}
In an ER model $\gmodel$ a \term{relationship key attribute}\footnote{These are more usually knows as foreign keys but I just can't bring myself to use this term, and also, in ISO standard SQL, they are known as referential attributes.} of an entity type $a$ is an attribute
...
\begin{lemma}
If $\gmodel$ is an ER model and if $R \subseteq \rkp$ then 
