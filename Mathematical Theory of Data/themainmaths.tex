...
a mono-source or else there is an intransitive functional dependency $\set{y_1,...y_m} \morph z$ which it factors through i.e. such that $\set{x_1,...x_n} \morph \set{y_1,...y_m}$. \commentary{for the thinking behind the exception that $\set{\xn}$ being a mono-source see team selection example.}
\end{definition}
...
\begin{oldtt}
Surely $yn$ would have to be attributes for intransitive lemma to be used to establish that $p$ is relationship-like. This is surely hopeless.
\end{oldtt}
\end{proof}
...
such that there is a \highlight{relationship-like} path $r:a \morph b$ and a path $p:b \morph \veee$ such that
