...
\item for each i, $1 \leq i \leq n$, the path $r_1 \circ r_2 ... \circ r_n$ is either a mono-source or else is not relationship-like, 
(in particular note that this implies $r_2$ is a mono-source and that, if $n \geq 2$, $r_2$ is not identifying-like)
