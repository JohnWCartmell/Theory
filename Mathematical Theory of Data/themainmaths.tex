...
or else for some entity type $d$ there is a non-empty \highlight{relationship-like} path $p:a \rightarrow d$ such that $\{x_1,...x_n\} \morph p$ is a functional dependency in $\gmodel$
...
there  is a \highlight{relationship-like} path $p:a \rightarrow d$ such
that 
...
or else there is an entity type $d$ and there is a \highlight{relationship-like} path $p:a \rightarrow d$ such that $\{x_1,...x_n\} \morph p$
...
or else there is a non-empty \highlight{relationship-like} path $r$ in $\gmodel$
