...
\hspace{2.5cm}\onslide<4->{\rightsquiggle $\tuple{sDept,sSv} \circ \widehat{\tuple{pDept,pNo}} 
                                                              = \tuple{sDept,sSv}$ }  \\
%\smallskip
\item $\headOfDeptInclusionDependency$   \\
\hspace{2.5cm}\onslide<5->{\rightsquiggle  $\tuple{dName,dHd} \circ \widehat{\tuple{pDept,pNo}} 
              = \tuple{dName,dHd}$}
\end{itemize}
\end{overprint}
}

\begin{frame}{Relational Sketch}
\vspace{0.9cm}
