...
\erDisplayPureLogicalWithoutAnimation
\begin{center}
\scalebox{0.75}{\input{../content/relationalMetaModel3.relational}}
\end{center}
\end{frame}
...
\scalebox{0.75}{\only<1>{\input{../content/relationalMM3PrimaryKeyEntryColumn.scope.tex}}} \only<2>{\scopeTriangle{column}{primary\ key\ entry}{column}{table}{of}{of}}
\end{equation}
\medskip
\begin{itemize}
...
\raisebox{-1cm}{\scalebox{0.65}{\input{../content/relationalMM3ForeignKeyEntryFromColumn.scope.tex}}}
\end{equation}
\begin{itemize}
...
\begin{equation}
\label{foreignKeyEntry.toScopeDiagram}
\raisebox{-1cm}{\scalebox{0.75}{\input{../content/relationalMM3ForeignKeyEntryTo.scope.tex}}}
\end{equation}
\begin{itemize}
...
\begin{equation}
\label{foreignKeyEntry.toScopeDiagram}
\raisebox{-1cm}{\scalebox{0.65}{\input{../content/relationalMM3ForeignKeyEntryTo.scope.tex}}}
\end{equation}
\begin{itemize}
...
\scalebox{0.8}{
\begin{tabular}{l c l}
\textbf{select} fkid,pkeid      &        & \textbf{select} fkid, pkeid \\ 
\textbf{from} foreign\_key\_entry&$\equiv$&  \textbf{from} foreign\_key fk, primary\_key\_entry pke \\
                                &        &  \textbf{where} fk.to\_table\_id = pk\\
                                &        &  \textbf{and} pke.of\_table\_id=pk 
\end{tabular} 
}
\end{frame}
