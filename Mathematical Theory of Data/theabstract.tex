...
Future work will also cover secondary keys, relationships implemented using secondary keys, implementation by hierarchical models (aka distinguishing composition relationships), 4th and 5th normal forms as pullbacks and other limits.  
\end{abstract}
