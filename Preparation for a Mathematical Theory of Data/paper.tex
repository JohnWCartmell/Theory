...
\note
When viewed abstractly each data specification is a theory of what is and  to each different notion of data specification corresponds a different notion of theory. An organisation of this thinking will constitute a mathematical theory of data. Such a theory has a role to play in improving  the way we think, talk about, design, develop, and transform, data specifications and in fostering significant improvements in available techniques and tools for their management. 
...
The most immediate consequence of the definition of maximal constrainedness is given by the next lemma.
\begin{lemma}
...
\end{align*}
Since $[L_c(g)]=[R_c(g)]$ then it followsfrom the definition of $\sim_c$ that there exists $k:b \morph c$ in 
...
such a data representation would not necessarily fail any of the classic goodness criteria, it is counter to the intuition we have of good data design. It seems that principles of no redundancy and maximum constrainedness are a basis for formalising this intuition.
...
I mention this  because multiple occurrences of this shape appearing in  a larger data specification are pointed out enthusiastically by Bachman\footnote{Though his diagrams have arrows that are the reverse of those here.} in his 1969 paper \textit{Data Structure Diagrams} \cite{Bachman1969}. 
