...
theory\footnote{The role of such a theory can be foregrounded by speaking of it
 as a \textit {theory of what is} and otherwise might be said to be an \textit{ontology}.} and  to each different notion of data specification corresponds a different notion of theory. An organisation of this thinking will lead to a mathematical theory of data. Such a theory has a role to play in improving  the way we think about, discuss, design, develop and transform data specifications. I strongly believe that a fully elaborated mathematical theory of data will foster significant improvements in  techniques and tools for the management of data. 
...
If $\catc$ is a locally finite category and $\reqtc$ is a set of instances, then
say that  $\catc$ is \term{complete} with respect 
to the requirement $\reqtc$ 
