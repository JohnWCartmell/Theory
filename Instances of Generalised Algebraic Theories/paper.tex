...
For $U$ a generalised algebraic theory, a $U$-algebra (previously defined algebraically in \cite{Cartmell78}, published in \cite{Cartmell86} ) can be defined to be any instance of the theory $U$ in the contextual category $\Fam$ of sets,
