...
\newcommand{\hatU}{\rule{0pt}{12pt}\hat {U}}
...
an \textit{instance of  a generalised algebraic theory $U$ in a contextual category \catc}  which I take to be synonomous 
with \textit{internal $U$-structure in contextual category \catc}. 
...
\commentary{Something about \highlight{$\hat tm$} and \hightlight{$\hat tc$}?
