...
%\newcommand{\genericInstance}{\dot{J}}
%\newcommand{\genericInstancePrime}{\dot{J'}}
...
\newcommand{\fonestar}   {f\onestar}             %{{f_1}\kern-.15em^*}
\newcommand{\ftwostar}   {f\twostar}             %{{f_2}\kern-.15em^*}
\newcommand{\fjstar}     {f\jstar}               %{{f_j}\kern-.2em^*}
\newcommand{\fjpstar}    {f\jpstar}              %{{f_{j-1}}\kern-.25em^*}
\newcommand{\fmonestar}  {f\monestar}            %{{f_{m-1}}\kern-.15em^*}
\newcommand{\fmstar}     {f\mstar}               %{{f_m}\kern-.25em^*}
\newcommand{\smstar}     {s\mstar}               %{{s_m}\kern-.25em^*}
\newcommand{\sonestar}   {s\onestar}              %{{s_1}\kern-.15em^*}
