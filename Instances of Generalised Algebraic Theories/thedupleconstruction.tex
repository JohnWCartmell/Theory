...
\begin{oldtt}
\begin{lemma}
\llabel{OLDduplestuplelemmaxxxxxxxxx}
If $x$, $y$ and $z$ are objects of a contextual category \catcw \commentary{\highlight{?} This used in monoid example in a single case. Can absolutedupletuplelemma be used instead?} 
...
\tbd
\end{proof}
\highlight{I am not sure we need this -- just use the previous binary lemma instead} \\
\highlight { -- at point of use will rely on $\tuple{v_1,v_2,v_3} = \tuple{\tuple{v_1,v_2},v_3}$}
\end{oldtt}
\begin{lemma}
