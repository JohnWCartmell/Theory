...
\gatinterpretationdetail{rightidentity4}{P}{\isT{Hom(x_1,x_1)}}{ \duple{s(\dot{x_1}),s(\dot{x_1}}^*Hom \in Cover(Hom) }
                                                                                     {lemma \ref{supplementarylemma}, (\ref{homintro}), (\ref{rightidentity2}) and (\ref{rightidentity3}}   \\
\gatinterpretationmapeqv                           {\tuple{\dot{x_1},\dot{x_1}}^*Hom}             {lemma \ref{thedupletuplelemma}} \\
\gatinterpretationdetail{rightidentityidmapping}{P}{\ofT{id(x_1)}{Hom(x_1,x_1)}}
                               {\duple{s({\dot{x_1}})}^*\fid \in Sect(\tuple{\dot{x_1},\dot{x_1}}^*Hom) }{lemma \ref{supplementarylemma}, (\ref{idintro}) and (\ref{rightidentity2})}  \\
\gatinterpretationmapeqv       {{\dot{x_1}}^*\fid}                                           {lemma \ref{thedupletuplelemma}} \\
...
\gatinterpretationmapeqv        {  \leftidentitylhsremapped     }
                                                                    {lemma \ref{thedupletuplelemma} and defn. of $\dot{x_2}$} \\
