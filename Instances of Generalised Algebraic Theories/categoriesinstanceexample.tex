...
If $I$ is a valid interpretation of $tc$ in a contextual category \catc then the sorts $Ob$ and $Hom$ of $tc$ 
...
\end{equation*}	
and this is relevant to us because in the lemma that follows we will show that for an interpretation $I$ to be valid the section $I(\circ)$ must be a section of $\compsix$.																	
	
					
Next we turn to $Ob^4$.
