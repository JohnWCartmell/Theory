...
\newcommand{\leftidentitymapped}{\tuple{\dot x_1,\dot x_1,\dot x_2,\dot x_1\circ \fid,id_{Hom}}^*\fcomp=s(id_{Hom})}

% Right identity axiom mapping
\newcommand{\rightidentitymapped}{\tuple{\dot x_1,\dot x_1,\dot x_2,id_{Hom},\dot x_2\circ \fid}^*\fcomp=s(id_{Hom})}
...
\begin{newtt}
As we show on table \lref{???} If $I$ is an instance of $tc$ in a contextual category \catcw then, with the adopted convention,
then $Ob$ is an object of \catcw such that $1 \base Ob$ and $Hom$ is an object such that $\OO \base Hom$. As described earlier 
we will name the two projections of $\OO$ as $x_1$ and $x_2$. In addtion we will define $\dot x_1,\dot x_2:Hom \morph \O$ by
$\dot x_i = p_{Hom} \circ x_i$.
\end{newtt}

Description of $\fid$.

Description of left identity axiom. 
...
and define   $\ddot y_i : \compdomain \morph Ob$, for $i = 1,2,3$, 
...
\tuple{\dot x_1,\dot x_1,\dot x_2,id_{Hom},\dot x_2 \circ \fid} \circ \compmorph =id_{Hom}
\end{equation}
and
\begin{equation}
