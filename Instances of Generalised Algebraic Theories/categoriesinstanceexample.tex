...
\newcommand {\assocgohremapped}{\tuple{\dddot z_2,\dddot z_3,\dddot z_4,g,h}^*\fcomp }
...
\begin{array} {cp{1.4cm}c}
                        && \Rnode{RTR}{\compsix}  \\[0.9cm]
\Rnode{RML}{Hom}        && \Rnode{RMR}{\compfive} \\[0.9cm]
\Rnode{RBL}{Hom}        && \Rnode{RBR}{\compfour} \\[0.9cm]
                        && \Rnode{RVBR}{\OOO}    
\end{array}
\begin{arrows}
% composition
...
\newcommand{\associativitytermdiagram} [3]
{
\begin{displaymath}
\begin{array}{c p{6cm} c}
                                                                       \\[0.6cm]
\Rnode{L}{\associativitypremisemapped} && \associativitytermdiagramrhs \\
&& \\[1.0cm]
\end{array}
\begin{arrows}
\ncdarr[25]{L}{RTR}
\alabel{\tuple{#1,#2,#3}}[0.6]
\ncarr[5]{L}{RML}
\alabel{#3}[0.6]
\ncarr[-5]{L}{RBL}
\blabel{#2}[0.6]
...
\associativitytermdiagram{\dddot z_1, \dddot z_3,\dddot z_4}{(\assocfogmapped) \circ q(\tuple{\dddot z_1,\dddot z_3},Hom)}{h}
\vspace{0.5cm}
