...
\newcommand{\leftidentitymapped}{\leftidentitytuple^*\fcomp=s(id_{Hom})}
...
We will show that an instance of $tc$ in a contextual category \catcw, i.e. an internal category in \catcw, 
