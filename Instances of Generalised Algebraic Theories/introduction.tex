...
in this paper  these paradigms will be followed as closely as is possible except that the term \term{instance} will substituted  for that of model. 
...
\note 
As we have indicated, in this paper, by \term{theory} we mean a signature plus axioms but 
...
style  definitions of model in either the general or the more restrictive sense so that in 
...
identities that we require are detailed. 
