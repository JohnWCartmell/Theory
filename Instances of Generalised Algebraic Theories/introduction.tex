...
that uses an operator $\crossx{}{}{}$ as a special case of pullback. The notation described is then used in the main definitions of \term{instance} and \term{valid interpretation} as given in section \ref{sectioninwhichinstanceisdefined} 
...
It can be seen from the detail definitions given in
section \ref{sectioninwhichinstanceisdefined}
that to every gat $U$ there is a theory of internal $U$-structures. We shall denote this theory as $\hatU$.
...
I wrote this paper after studying a draft of [\cite{BCDEpaper}] sent to me by 
 one of its authors, Peter Dybjer. I hope that the material presented here sheds some light on that paper. 
They give two examples and I have  elaborated the same two. 
