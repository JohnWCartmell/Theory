...
in this paper  we will follow these paradigms as closely as is possible except that the term \term{instance} will substituted  for that of model. 
...
\note 
As we have indicated, by \term{theory} we mean a signature plus axioms but 
\commentary{chance to defined generalised signature as a set of symbols along with rules for how they can be used.}
...
$\hat{U}$ which is the theory of internal $U$-structures\footnote{This is reliant on their being a generalised algebraic theory of contextual categories and at some point we need to discuss the extent or the manner to which this is true for there are \highlight{nuances} here.}.
...
including a description of Voevodski's `s' operator and of a local product notation $\crossx{}{}{}$ as a special case of pullback. Various
...
then enable us to present  examples and then to simplify them. 
