...
If $I$ is a partial mapping of T-rules and $\in$-rules of a theory $U$ to objects, respectively sections of a contextual category \catcw,
 ...
 if \foreachj, the rule \IsOmega{j} is consistently interpreted by $I$ and if the rule \IOmega{m} is consistently interpreted by $I$
then \foreachj, 
...
To prove the lemma in the case of $m=1$ we need simply show that 
 ...
 This is the case because by lemma \lref{typeweakeninglemma} $\crossx{a}{I(r_{\Omega_1})}{1}) = I(\IOmega{j})$
...
and that the rule \IOmega{m} is consistently interpreted by $I$. From this it follows
...
By an \highlight{as yet unformulated} tower lemma we have $I(r_1) \base ... I(r_{n-1}) \base I(r_Q)$ in \catc.
