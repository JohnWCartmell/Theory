...
\end{lemma}
\begin{proof}  
This, I think,  follows from use of the Substitution Lemma (lemma \lref{substitutionlemma},
and from the lemma regarding the interpretation of substitutions i.e. lemma \ref{substitutioninterpretation}. 
\highlight{Do we need induction on length of term or type expression?}
\commentary{Be careful: when realisation is empty  then substituting it does not yield longer expression.}
\tbd
\end{proof}
