...
show intermediate steps. Each step is justified by reference to earlier steps and by either application of one clauses (i) through \highlight{(v)} of the definition of instance, as appropriate, or by reference to one of the lemmas given earlier.}
...
\\[-0.1cm]
\gatinterpretationdetail{tm2}{\wM}{\isT{M}}{\doubleM \in Cover(M)}{\highlight{(v)} and (\ref{tm1})} \\[0.3cm]
\gatinterpretationdetail{tm3}{\wM}{\ofT{w}{M}}{s(id_M) \in Sect(\doubleM)}{(ii)(b) and (\ref{tm1})} \\[0.3cm]
\gatinterpretationdetail{tm4}{\xM}{\isT{M}}{\trebleM \in Cover(\doubleM)}{\highlight{(v)}, (\ref{tm2}) and (\ref{tm1}) } \\[0.3cm]
\iffalse % Not USED
...
\fi
\gatinterpretationdetail{tm7}{\yM}{\isT{M}}{\quadM \in Cover(\trebleM)}{\highlight{(v)}, (\ref{tm1}) and (\ref{tm4})} \\[0.3cm]
...
\\[-0.1cm]
\gatinterpretationdetail{tm12}{\wM}{\ofT{unit}{M}}{\crossx{M}{unit}{1} \in Sect(\doubleM)}{\highlight{(vi)}, (\ref{tm1}) and (\ref{tm11})} \\[0.3cm]\gatinterpretationmapeqv{s(p_M \circ unit)} 
