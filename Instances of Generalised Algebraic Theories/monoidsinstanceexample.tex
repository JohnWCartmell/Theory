...
show intermediate steps. Each step is justified by reference to earlier steps and by either application of one clauses (i) through \highlight{CHECK: } of the definition of instance, as appropriate, or by reference to one of the lemmas given earlier.}
