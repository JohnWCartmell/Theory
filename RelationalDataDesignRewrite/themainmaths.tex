...
$E_{\qntuple} \circ E_{\qntuple}^{-1} = id{E_a}$
...
and a  path $z:d \morph c$ which is not equivalent to an identifying path such that $y \simeq p \circ z$.
\end{lemma}
\begin{proof}
...
Either $k=0$ and $\qntuple = \langle x_1,...x_n \rangle$ in which case $E_{\langle x_1,...x_n \rangle}$ is
...
it follows that $p_1,...p_k,z_1,...z_l$ subsume $\langle y_1,..y_m \rangle$\commentary{CHECK THIS}, 
