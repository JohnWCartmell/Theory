...
In a well-formed model $\genericmodel$ if $\{x_1,...x_n\} \morph z$  is a non-trivial intransitive
...
\end{lemma}
\begin{proof}
Since the model $\genericmodel$ is has the \fdfactoring the functional dependency $\set{x_1,...x_n} \morph z$ can be factored through an intransitive functional
