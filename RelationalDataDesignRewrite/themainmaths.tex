...
then the transformed model $\genericphysical$ is a well-formulated, restriction-free relational ER model with the fd factoring property 
which is therefore in S3NF.  Further we will show that if $\gmodel$ is without caveats then $\genericphysical$ is also without caveats
and is therefore in BCNF. 
