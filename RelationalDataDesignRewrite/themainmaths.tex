...
\begin{theorem}
\noindent If an ER model $\gmodel$ is well-formulated, has the \fdfactoring\ property and is free 
of attribute redundancy then it is in Strong Third Normal Form. If in addition $\gmodel$
is free of attribute redundancy without caveat then is in Boyce-Codd Normal form.
\end{theorem}
\begin{proof}
