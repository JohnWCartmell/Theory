...
Codd introduces the relational model in a 1970 paper [\cite{Codd1970}] and introduces the idea of normal form.
The term `functional dependency' is NOT in this paper and not clear whether normal form goes as far as 3NF.

The terms `functional dependency' and  `third normal form' are introduced in an IBM techical report in 1971
published in a now out of print book \cite{Codd1971} (also unavailable on Amazon).

\section{Chen}
Chen paper \cite{Chen1976} simultaneously introduced the idea of entities being dependent on binary relationships 
