...
\commentary{I feel this first sentence makes sense to me because i am used to think of relationships 'following' each other. But I cannot expect my reader to have this way of thinking built-in. I need be more explicit. Maybe along line of type A having a single identifying relationship to type B which in turn  to type C and so on.}
\begin{worktt}
