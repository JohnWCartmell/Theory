...
\usepackage{comment}
\excludecomment{explanationForAI}  % defines an environment that allows me to comment without the comment being rendered in the final document.
...
%The following commented out 13 June 2026 because I get a command already defined error. But why I needed it and now don't --- well I don't know.
...
% \etnodeLabelled{nodelabel}{x}{y}    x,y of bottom left corner
\newcommand{\etnodeLabelled}[3]{
\rput(#2,#3){\rnode{#1}{
\pnode(0,0.75){#1UL} \pnode(0,0.25){#1LL}
\psframebox[framearc=0.2,fillstyle=solid,fillcolor=lightyellow]{\rule[1cm]{2cm}{0pt}} 
\pnode(0,0.75){#1UR} \pnode(0,0.25){#1LR}
