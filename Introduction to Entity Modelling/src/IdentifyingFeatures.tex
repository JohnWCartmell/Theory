...
The impact of these arrangements\commentary{this word \textit{arrangements}then shall be used to tie together several chapters} of identifying features 
...
\subsubsection{Example --- Barker's Boarding Pass}
...
\subsection{Arrangements of Identifying Relationships}
\mynote
