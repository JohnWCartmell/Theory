...
\mynote
\commentary{we can model without drawing diagrams --- I can't say that everyone prefers diagrams to text but I do 
we prefer diagrams}
...
\end{noteforfuture}\commentary{this will need to come later because it mentions identifying features}