...
\iffalse
 ...
 \commentary{Maybe the first section on scope occurs next to give interest to the rather dry `Referencing Entities'}
 \input{AirportGateExample.tex}
 \input{CoreversusDerivative.tex}
 \input{CommunicatingEntityInstances}
 %\iffalse
 \commentary{I think scope needs to move earlier because 
 it is part of the interest of referencing entities to communicatev relationships.}
 \input{Scope.tex}
