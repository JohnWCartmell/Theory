...
Sharing referentials across different relationships --- 
 ...
 I have demonstrated the ubiquity of commutative diagrams of relationships
and indicated how by recognising them,  relational database design can be \textit{right first time}. \\
\hline
12 & \mysection{CoreversusDerivative} &  Core versus derivative, conceptual core, data cores, goodness criteria. The Core and Derivatives? \\
\hline
