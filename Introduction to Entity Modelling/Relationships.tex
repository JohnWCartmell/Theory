...
\commentary {this will cause two mathematical sections to be consecutive.}
...
\raisebox{-0.45cm}{\input{\ImagesFolder/shlaerLang-StudentProfessor..relationship..diagram.tex}}
\end{equation}
...
\raisebox{-0.8cm}{\input{\ImagesFolder/shlaerLang-StudentDept..relationship..diagram.tex}}
\end{equation}
...
as for example in the relationship between a professor and the department they are a part of:\commentary{this diagram is wrong!! should be a solid line}
\begin{equation}
\label{shlaerLang-ProfessorDept..relationship..diagram}
\raisebox{-0.45cm}{\input{\ImagesFolder/shlaerLang-ProfessorDept..relationship..diagram.tex}}
\end{equation}
...
in a different style, the Shlaer-Melor style, by Neil Lang  in a  paper written jointly with Sally Shlaer. 
...
\input{\ImagesFolder/shlaerLang-DeptStudentProfessor..relationships..diagram.tex}
\end{erboxedFigure}
...
\commentary{COMPLETE THIS THOUGHT}