...
\begin{newtt}
Does it make sense to state the simple version we need and then state a strong version
including the hypothesis needed for the inductive step and the proof?.
\end{newtt}
\begin{lemma}
\vlabel{taketwo}
...
First some auxilary lemmas and then the proof of the representation lemma.
\subsection{Auxiliary Lemmas}
These are used in the proof of the represenation lemma}
\begin{lemma}
\vlabel{conepass}
If 
\begin{center}
...
\subsection{Proof of Represenation Lemma}
\begin{proof}
\commentary{Not yet proven}
\daynote{20th November 2020 for latest thinking on how to restructure this proof.}
