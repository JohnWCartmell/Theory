...
\vspace{2cm}
\item if $Y$ is $\crossx{A}{B}{X'}$ for some $A$, $B$ and $X'$ where $X < X'$ and $X' \base B$ and $X' < A$ then
$$
\proj{\crossx{A}{B}{X'}}{X} = \{ \tuple{\pc{\crossx{A}{B}{X'}}{A},\proj{A}{X}   };\tuple{q(\pc{A}{X'},B),\proj{B}{X'}} \}
$$
\vspace{0.5cm}
\begin{displaymath}
\begin{array}{cp{1.0cm}cp{0.3cm}cp{1.0cm}cp{0.3cm}c}
\Rnode{X} {X}  && \Rnode{Xp}{X'} && && \Rnode{A}{A} && \Rnode{AB}{\crossx{A}{B}{X'}}                     \\ [0.5cm]
               &&                && \Rnode{B}{B}  &&  &&     
\end{array}
\end{displaymath}
\ncsar{B}{Xp}
\ncsar{AB}{A}
\ncaarr[15]{q(\pc{A}{X'},B)}{AB}{B}
\xxsar{Xp}{X}
\xxsar{A}{Xp}
...
\item if $Y$ is $\crossx{A}{B_m}{X'}$ for some $A$, $B_1,...B_m$ and $X'$ where $X < X'$ and $X' \base B_1 \base ... \base B_m$ and $X' < A$ then
$$
\proj{\crossx{A}{B_m}{X'}}{X} = \{ \tuple{\pc{\crossx{A}{B_m}{X'}}{A},\proj{A}{X}   };\tuple{q(\pc{A}{X'},B_m),\proj{B_m}{X'}} \}
$$

\vspace{1.0cm}
\begin{displaymath}
\begin{array}{cp{0.5cm}cp{0.2cm}c   p{0.2cm}c c  p{0.2cm}l   p{0.2cm}c   c  p{0.1cm}c }
\Rnode{X} {X}  && \Rnode{Xp}{X'} &&    &&&     \Rnode{A}{A} && \Rnode{AB1}{\crossx{A}{B_1}{X'}} 
&& \Rnode{AB2}{\crossx{A}{B_2}{X'}}     &\Rnode{ABe}{\hdots}    && \Rnode{ABm}{\crossx{A}{B_m}{X'}}           \\ [0.6cm]
               &&                && \Rnode{B1}{B_1}   && \Rnode{B2}{B_2} &\Rnode{Be}{\hdots}   && \Rnode{Bm}{Bm}     &&  &&     
\end{array}
\end{displaymath}
\ncsar{B1}{Xp}
\ncsar{B2}{B1}
...
\ncsar{AB2}{AB1}
\ncsar{ABm}{ABe}
\ncaarr[15]{q(\pc{A}{X'},B_m)}{ABm}{Bm}
\ncpar{Xp}{X}
\ncpar{A}{Xp}
\ncbpar[-30]{\pc{\crossx{A}{B_m}{X'}}{A}}{ABm}{A}
\vspace{0.5cm}

\item if $Y$ is $\crossx{A}{B'}{X}$ where $X < A$, $X < B$ and $B \base B'$ then
$$
\proj{\crossx{A}{B'}{X}}{\crossx{A}{B}{X}} = \{\tuple{q(\pc{A}{X},B'),\proj{B'}{B}}\}
$$
\vspace{0.5cm}
\begin{displaymath}
\begin{array}{cp{1.0cm}cp{0.3cm}cp{0.3cm}cp{0.3cm}c}
\Rnode{X} {X}  &&              && \Rnode{A}{A} && \Rnode{AB}{\crossx{A}{B}{X}} && \Rnode{ABp}{\crossx{A}{B'}{X}}  \\ [0.5cm]
               && \Rnode{B}{B} && \Rnode{Bp}{B'}  &&  &&     
\end{array}
\end{displaymath}
\ncsar{B}{X}
\ncsar{Bp}{B}
