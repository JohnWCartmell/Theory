...
\noindent
Illustration. Suppose the following diagram commutes in a category \cat{C}: 
\begin{center}
\begin{equation}
\begin{array}{cp{0.1cm}cp{0.1cm} c}
            & &\Rnode{A1}{A_1}                           \\ [0.4cm]
...
\end{array}
$
\ncaarr{f_1 \circ g}{A1}{C}
\jcbarr{f_2 \circ g}{A2}{C}. If C has finite limits then we will have mediating morphisms $h$ and $h'$ as shown in the following diagram 
...
$
\ncaarr{h_1}{X}{A1}
\jcbarr{h_2}{X}{A2} is `tighter' too
