...
each of $f_1$ and $f_2$  is a d-morphism and and the characteristic diagram
of
...
\noindent For any other d-morphism $a':B\darrow A'$ leaving B, the morphism $e \circ a'$ is a d-morphism.
...
the morphisms $y \circ x_1$ and $y \circ x_2$ are d-morphisms and the characteristic diagram
of
...
$p_1: \fibrex{B}{B'}{D} \dmorph B$ and  $p': \fibrex{B}{B'}{D} \dmorph B'$ such that :
