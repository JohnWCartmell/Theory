...
s_2 \in Sect(\sonesub \crossx{A}{B_1}{1}),         \\
s_3 \in Sect(\stwocascade \crossx{A}{B_2}{1}),     \\
...
\end{align*}
When $B$ is some object such that $B_{i+1} < B$ in \catcw then wecan show that$\sisucccascade (\crossx{A}{B}{1})=\duplesisucc ^* B$ as follows:
\begin{align*}
