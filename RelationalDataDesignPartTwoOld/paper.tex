...
DRAFT \commentary{ Original Dated 2016 }
      ...
      \commentary{ Addition of variant definitions, notes and  corrections 25/29 April 2019.}
			...
			\commentary{ Identifying Sets section developed. Introduction of well-factored. 24 July 2019}
\end{center}
...
\begin{definition}
A model \genericmodel\ satisfies the minimality conditions iff 
\begin{enumerate}
\item for every entity type $a$, the set $I_a$ is a minimum mono-source i.e 
there is no proper subset which is a mono-source,
\item whenever $P$ is representative
...
\commentary{This assumes $f_i$ total. Need restate if $f_i$ partial and 
