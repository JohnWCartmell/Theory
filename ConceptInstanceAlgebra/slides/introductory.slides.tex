...
\end{tightquote}
\medskip
Ryles suggestion that such ambiguity applies to \textit{most} words and his use of words \textit{inflection} and \textit{root} suggest some kind of conceptual grammar. 
\end{frame}
