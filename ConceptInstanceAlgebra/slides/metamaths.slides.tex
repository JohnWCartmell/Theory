...
\only<#1>{ {\footnotesize \gatdisplayrule{\ofT{x_1}{\cpt_1},...\, \ofT{x_{n}}{\cpt_{n+1}(x_1,...x_{n-1})}} {\isT{\cpt_{n}(\xn)}} } }
...
\begin{frame}{Generalised Algebraic Theory of Contextual Categories cont.}
\begin{itemize}
...
\item Can show that $I_CI$ and $I_CC$ extend to pseudo inverses in the category \cat{GAT}.
