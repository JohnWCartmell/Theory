...
\usepackage {textcomp}
\usepackage{ulem}
\usepackage[left=1.5cm, right=1cm,  top=1cm, bottom=1.0cm]{geometry}
...
\hdashline
\verb'\SUBtFORx[j]' & $\SUBtFORx[j]$ & NEED TO MAKE THIS arg mandatory for readability reasons -- otherwise doesn't read like a vector thing \\   
\hline
