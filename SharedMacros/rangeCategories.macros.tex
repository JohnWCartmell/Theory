...
\newcommand{\rstdot}[1]{\dot{\overline {\vphantom{f}#1}}}
\newcommand{\rstdotItself}{$\dot{\overline{\kern0.2cm\nudgeup{0.2cm}}}$}
% range  
...
\newcommand{\rngdot}[1]{\dot{\reallywidehat{\vphantom{f}#1}}}
\newcommand{\rngdotItself}{$\dot{\widehat{\kern0.2cm\nudgeup{0.2cm}}}$}
\newcommand{\abrng}[1]{\rng{\tighten{#1}}}

\newcommand{\converse}[1]{{#1}^\circ}
\newcommand{\converseItself}{$^\circ$}
...
% support and cosupport orderings
\newcommand{\sleq}{\mathrel{\underset{s}{\leq}}}
\newcommand{\cleq}{\mathrel{\underset{c}{\leq}}}
\newcommand{\scleq}{\mathrel{\underset{sc}{\leq}}}
...
\newcommand {\twoTighteningOne}[1]{#1_1 \circ \rng{\rst{#1_2} \circ #1'_1}}
\newcommand {\twoTighteningTwo}[1]{\rst{#1_2} \circ #1'_1 \circ \rng{#1_1}}
\newcommand {\twoTighteningThree}[1]{\rst{#1'_1 \circ \rng{#1_1}} \circ #1_2}
...
%zigzagTupleReplaceOut{f}{n}{g}    GIVES <f_1,...f'_n, g>
\newcommand{\zigzagTupleReplaceOut}[3]
{
\tuple{#1_1,#1'_1,...#1_{#2-1},#1'_{#2-1},#3}    
}
...
\newcommand{\zigzagRightFactorTuple}[2]
{
\tuple{\rng{#1_1},#1'_1,...#1_{#2-1},#1'_{#2-1},#1_{#2}}    
}
%zigzagRightFactorTupleLedIn{h}{m}{f_n}
\newcommand{\zigzagRightFactorTupleLedIn}[3]
{
\tuple{#3 \circ \rng{#1_1},#1'_1,...#1_{#2-1},#1'_{#2-1},#1_{#2}}    
}

%zigzagLeftFactorTuple{f}{n}
\newcommand{\zigzagLeftFactorTuple}[2]
{
\tuple{#1_1,#1'_1,...#1_{#2-1},#1'_{#2-1},\rst{#1_{#2}}}     
}

%zigzagLeftFactorTupleLedOut{h}{n}{f_n}
\newcommand{\zigzagLeftFactorTupleLedOut}[3]
{
\tuple{#1_1,#1'_1,...#1_{#2-1},#1'_{#2-1},\rst{#1_{#2}} \circ #3}     
}
...
%zigzagRightFactorTailTupleLedIn{h}{n}{m}{g}
\newcommand{\zigzagRightFactorTailTupleLedIn}[4]
{
\tuple{#4 \circ \rng{#1_#2},#1'_#2,...#1'_{#2+#3-2},#1_{#2+#3-1}} 
}

%zigzagTailTupleReplaceIn{h}{n}{m}{g}
\newcommand{\zigzagTailTupleReplaceIn}[4]
{
\tuple{#4,#1'_#2,...#1'_{#2+#3-2},#1_{#2+#3-1}} 
}
...
%\zigzagzigTwo{x}{y}{f}[g] %g is optional for circ f1
% This is a zig zag zig. 
% zig one is  f1 : x1 -> y1 
% zig one is  f'1 : x2 -> y1
\NewDocumentCommand{\zigzagzigTwo}{m m m o}
{
...
%\zigzagTwo{x}{y}{f}
% zig zag of length two so <z1, z'1, z2>
\NewDocumentCommand{\zigzagTwo}{m m m}{
\begin{array} {c c c c}
 &\Ob{#2}{1}&&\Ob{#2}{2}    \\[0.8cm]
\Ob{#1}{1}&&\Ob{#1}{2}
\end{array}
\begin{arrows}
\ncarr{#11}{#21} \alabel{#3_{1} }[0.6][0.4]
\ncarr{#12}{#21} \blabel{#3'_{1} }[0.6][0.4]
\ncarr{#12}{#22} \blabel{#3_{2} }[0.7][0.4]
\end{arrows}
}
