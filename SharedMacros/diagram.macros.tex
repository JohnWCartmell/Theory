...
%\upTriangle{left}[padcm]{apex}[padcm]{right}[heightcm]{flat}[npos]{diagonal}[npos]{riser}[npos]

\NewDocumentCommand{\upTriangle}{m m m O{1cm} O{0cm} m m m O{0.5}}
{
\def\pleft{#1}
\def\papex{#2}
\def\pright{#3}
