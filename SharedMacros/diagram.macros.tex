...
%\downTriangleShape
     %{down}[height]{left}[lpadding]{right}[rpadding]
...
%\binarysourcePreceeded{a}{b}{c}{d}{f}{g}{h}
\newcommand{\binarysinkPreceeded}[7]{
\begin{array}{c p{0.5cm} c p{0.5cm} c }
              &&               &&   \Rnode{c}{#3} \\[0.01cm]
\Rnode{a}{#1} && \Rnode{b}{#2} &&                \\[0.01cm] 
              &&               &&   \Rnode{d}{#4} 
\end{array}  
\begin{arrows}
\ncarr{a}{b}
...
%\binarysinkContinued{a}{b}{c}{d}{f}{g}{h}
\newcommand{\binarysinkContinued}[7]{
\begin{array}{c p{0.5cm} c p{0.5cm} c }
\Rnode{a}{#1} &&                                  \\[0.01cm] 
              &&   \Rnode{c}{#3} && \Rnode{d}{#3} \\[0.01cm]
\Rnode{b}{#2} 
\end{array} 
\begin{arrows}
\ncarr{a}{c}
