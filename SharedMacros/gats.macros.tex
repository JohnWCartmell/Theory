...
\newcommand{\ZDeltap}[1][]{\gatdisplayrule[#1]{\xDelta{m}}{\isT{\Delta'}}}
\newcommand{\ZtDelta}[1][]    {\gatdisplayrule[#1]{\xDelta{m}}{\ofT{t}{\Delta}}}
\newcommand{\ZtpDelta}[1][]    {\gatdisplayrule[#1]{\xDelta{m}}{\ofT{t'}{\Delta}}}
...
\newcommand{\ItDelta}[2] [P]  {\gatdisplayrule{#1}{\tDelta{#2}}}
