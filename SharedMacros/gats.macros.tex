...
\newcommand{\SUBtFORx}[1][m]{t_1|x_1,...t_{#1}|x_{#1}}
\newcommand{\SUBtpFORx}[1][m]{t'_1|x_1,...t'_{#1}|x_{#1}}
\newcommand{\tDelta}[1]{\ofT{t_{#1}}{\Delta_{#1}[\SUBtFORx[i-1]]}}
\newcommand{\tpDeltap}[1]{\ofT{t'_{#1}}{\Delta'_{#1}[\SUBtpFORx[i-1]]}}

\newcommand{\SUBsFORy}[1][m]{s_1|y_1,...s_{#1}|y_{#1}}
\newcommand{\SUBspFORy}[1][m]{s'_1|y_1,...s'_{#1}|y_{#1}}
...
\newcommand{\ZDelta}[1][]{\gatdisplayrule[#1]{\xDelta{m}}{\isT{\Delta}}}
\newcommand{\ZtDelta}[1][]    {\gatdisplayrule[#1]{\xDelta{m}}{\ofT{t}{\Delta}}}
\newcommand{\ZDeltaSUBtnFORxn}[1][]{\gatdisplayrule[#1]{Q}{\isT{\Delta[\SUBtFORx]}} }
\newcommand{\ZtDeltaSUBtnFORxn}[1][]{\gatdisplayrule[#1]{Q}{\ofT{t[\SUBtFORx]}{\Delta[\SUBtFORx]}} }
\newcommand{\ZOmega}[1][]{\gatdisplayrule[#1]{\yOmega{m}}{\isT{\Omega}}}
\newcommand{\ZsOmega}[1][]    {\gatdisplayrule[#1]{\yOmega{m}}{\ofT{s}{\Omega}}}
\newcommand{\ZOmegaSUBsmFORym}[1][]{\gatdisplayrule[#1]{Q}{\isT{\Omega[\SUBsFORy]}} }
\newcommand{\ZsOmegaSUBsmFORym}[1][]{\gatdisplayrule[#1]{Q}{\ofT{s[\SUBsFORy]}{\Omega[\SUBsFORy]}} }
% I(ndexed} and requiring an index as an argument
\newcommand{\IDelta}[1]  {\gatdisplayrule{\xDelta{#1-1}}{\isT{\Delta_{#1}}}}
\newcommand{\ItDelta}[2] [Q]  {\gatdisplayrule{#1}{\tDelta{#2}}}
