...
%\contextShortstyle{x}{\Delta}{n}
\newcommand{\contextShortstyle}[3]
{\ofT{#1_1}{#2_1},... \ofT{#1_{#3}}{#2_{#3}(#1_{#3-1})}
}
...
\makebox[#1]{$#3$ \dotfill}\dotfill #2   %was \dotfill} \dotfill \  #2 but this doesnt look good when #2 empty
}
%*********************************
%*********************************
