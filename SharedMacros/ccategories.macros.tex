...
% NEW 8/02/2022
% Idea is to position long labels better
% restricted to single label per node connection though
% \salabel{label}[npos][labelsep_pts]
\newcommandx*\salabel[3][2=0.5,3=2,usedefault]
{
\ncput[npos=#2]{\uput[r](0,0) {\footnotesize $#1$} }  % NEED DO BETTER FOR ARROWS IN OTHER DIRECTIONS
}
% \sblabel{label}[npos][labelsep_pts]
\newcommandx*\sblabel[3][2=0.5,3=2,usedefault]{\nbput[labelsep=#3pt,npos=#2]{\footnotesize $#1$}}
