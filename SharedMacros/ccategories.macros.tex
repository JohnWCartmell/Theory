...
\ncline[linestyle=none]{#1}{#2} 
\ncput[nrot=:U]{
               \pnode(-0.1,-0.05){#1jaggedsourceto#2}
               \pnode(-0.3,0.05){#1jaggeddesto#2}
                }
 \ncline[nodesepB=0pt]{#1}{#1jaggedsourceto#2}
 \ncline[nodesepA=0pt, nodesepB=0pt]{#1jaggedsourceto#2}{#1jaggeddesto#2}
 \setlength{\sarnodesepA}{-3pt}
 \ncsar{#1jaggeddesto#2}{#2}
