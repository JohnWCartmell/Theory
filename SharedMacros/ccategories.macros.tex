...
\newcommand{\slightbm}[1]{%
  \ensuremath{%
    \mathchoice
      {\ooalign{$\displaystyle #1$\cr\kern0.1pt$\displaystyle #1$\cr}}
      {\ooalign{$\textstyle #1$\cr\kern0.1pt$\textstyle #1$\cr}}
      {\ooalign{$\scriptstyle #1$\cr\kern0.05pt$\scriptstyle #1$\cr}}
      {\ooalign{$\scriptscriptstyle #1$\cr\kern0.03pt$\scriptscriptstyle #1$\cr}}
  }%
}

\newcommand{\reqt}{\slightbm{\mathcal{R}}}               %EXPERIMENT

%\newcommand{\reqtc}[1][\catc]{\reqt_{#1}}
%\newcommand{\reqtcp}[1][\catcp]{\reqt_{#1}}
\newcommand{\reqtc}[1][\catc]{\reqt}
\newcommand{\reqtcp}[1][\catcp]{\reqt}
...
\newcommand{\Rel}{\ensuremath{\textbf{Rel}} }
\newcommand{\Fin}{\ensuremath{\textbf{Fin}} }
\newcommand{\FinPar}{\ensuremath{\textbf{FinP}} }
\newcommand{\Par}{\ensuremath{\textbf{Par}} }
\newcommand{\SetP}{\ensuremath{\textbf{SetP}} } % sets and partial functions
...
\newcommand{\ncarr}[3][0]{\ncarc[arcangle=#1,nodesepA=\arrnodesepA,nodesepB=\arrnodesepB,offsetA=\arroffsetA,offsetB=\arroffsetB]{->}{#2}{#3}}

\newcommand{\ncarrarc}[4]{\ncarc[arcangleA=#3,arcangleB=#4, nodesepA=\arrnodesepA,nodesepB=\arrnodesepB,offsetA=\arroffsetA,offsetB=\arroffsetB]{->}{#1}{#2}}

\newcommand{\ncarrrecursive}[5]{\ncarc[arcangleA=#3,arcangleB=#4, ncurv=#5, nodesepA=\arrnodesepA,nodesepB=\arrnodesepB,offsetA=\arroffsetA,offsetB=\arroffsetB]{->}{#1}{#2}}

%\ncstrikeout{A}{B} used to strike a red line through a straightline morphism
\newcommand{\ncstrikeout}[2]
{
  \ncline[offsetA=-5pt,offsetB=5pt,nodesepA=\arrnodesepA,nodesepB=\arrnodesepB, linecolor=red]{#1}{#2}
}
