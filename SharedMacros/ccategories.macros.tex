...
\newcommand{\dmorph}{\rightarrowtriangle}
...
\ncarc[nodesepA=\sarnodesepA,nodesepB=\sarnodesepB,offsetA=\saroffsetA,offsetB=\saroffsetB,arcangle=#1]{-}{#2}{#3}
%\ncput[nrot=:R,npos=1]{\pstriangle(0,0)(.2,.2)}
%\ncput[nrot=:R, npos=1]{\psline(0.1,0)(0,0.2)}
%\ncput[nrot=:R, npos=1]{\psline(0,0)(-0.1,0)}
%\ncput[nrot=:R, npos=1]{\psline(-0.1,0)(0,0.2)}
\ncput[nrot=:R, npos=1]{\psline(0.08,0)(0,0.18)}
\ncput[nrot=:R, npos=1]{\psline(0,0)(-0.08,0)}
\ncput[nrot=:R, npos=1]{\psline(-0.08,0)(0,0.18)}
\setlength{\sarnodesepA}{\sarnodesepAsav}
\setlength{\sarnodesepB}{\sarnodesepBsav}
}
...
\addtolength{\sarnodesepA}{3pt}
\addtolength{\sarnodesepB}{7pt}
\ncarc[nodesepA=\sarnodesepA,nodesepB=\sarnodesepB,offsetA=\saroffsetA,offsetB=\saroffsetB,arcangle=#1,linestyle=dashed]{-}{#2}{#3}
\ncput[nrot=:R,npos=1]{\pstriangle(0,0)(.2,.2)}
\setlength{\sarnodesepA}{\sarnodesepAsav}
\setlength{\sarnodesepB}{\sarnodesepBsav}
}
...
% par - p-arrow
\newcommand{\oldncpar}[3][0]{
\setlength{\sarnodesepAsav}{\sarnodesepA}
\setlength{\sarnodesepBsav}{\sarnodesepB}
\addtolength{\sarnodesepA}{3pt}
\addtolength{\sarnodesepB}{3pt}
\ncarc[nodesepA=\sarnodesepA,nodesepB=\sarnodesepB,offsetA=\saroffsetA,offsetB=\saroffsetB,arcangle=#1]{-}{#2}{#3}
\ncput[nrot=:L, npos=1]{\psline(0,0)(0.13,0.2)}
\ncput[nrot=:L, npos=1]{\psline(0.05,-0.05)(.20,0.15)}
\ncput[nrot=:L, npos=1]{\psline(0,0)(-0.13,0.2)}
\setlength{\sarnodesepA}{\sarnodesepAsav}
\setlength{\sarnodesepB}{\sarnodesepBsav}
}
...
% bpar - below labelled p-arrow
\newcommand{\ncbpar}[4][0]{
\ncpar[#1]{#3}{#4}
\nbput{\footnotesize $#2$}
}
% apar - above labelled p-arrow
\newcommand{\ncapar}[4][0]{
\ncpar[#1]{#3}{#4}
\naput{\footnotesize $#2$}
}
