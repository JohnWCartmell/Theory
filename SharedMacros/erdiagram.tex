...
%            mandatory and optional and solid for core and hollow for derivative.
% 02/12/2025 Attribute markers: change \circle to \Circle after failure on texlive.
%            Need more work on these markers though because looking wrong sized now. 
%
% ***********************************************************
...
{\fontsize{6}{8}\selectfont $\Circle$}  % changed from \circle after moving to texlive
