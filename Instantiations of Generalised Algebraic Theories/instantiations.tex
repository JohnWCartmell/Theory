...
a \term{preinstantiation} $I$ of  \gatUw in \catcw consists of a pair :
\begin{itemize}
...
Note that I will say that an instantiation $I$ of \gatUw in \catcw extends a preinstantiation $P$ of \gatUw in \catcw to mean that for each sort symbol $A$ of \gatU,
...
\gatdisplayrule{\xDelta{n}}{\isT{\Delta}} (as an object $a$ of \catc, say) before we can say whether a preinstantiation of an operator with introductory rule \genericfintroductoryrule
