...
If $S$ is a sketch for a category \catcw with epi-mono splits considered as a data specification with requirement $\reqtc$\ }
\iffalse
...
If $S$ is a sketch for category with finite products and epi-mono splits, \catcw, considered as a data specification with requirement $\reqtc$\ }
