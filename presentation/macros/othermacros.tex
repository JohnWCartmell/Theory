...
{If $S$ is a sketch for category \catcw and if $S$ is considered as a data specification with requirement $\reqtc$\ }
...
\newcommand{\goodnesscriteria}[1]
{\textbf{Goodness Criteria #1:}}
...
\newcommand{\romdown}[1]{\rule[-#1]{0cm}{0.1cm}}
...
{
\binarysourcediag{#1}{#2\roomup{0.5cm}}{#3}{#4}{#5}
\begin{arrows}
\ncarr{b}{c}
\alabel{#6}
\end{arrows}
