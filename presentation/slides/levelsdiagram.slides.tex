...
\begin{tabular}{p{6cm}}
\\[0.5cm]
sketch of category of some kind \\[0.9cm]
sketch as above with morphisms distinguished to indicate implementation by containment relationship \\[0.5cm]
sketch with distinguised morphisms plus  foreign keys for some non-distinguished morphisms \\[0.5cm]
IDL, XML, SQL etc\\
