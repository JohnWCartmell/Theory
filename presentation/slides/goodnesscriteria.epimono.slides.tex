...
\highlight{Remove this on inline into representationlemma}
...
If \catcw is a category with designated monomorphisms and epimorphsims 
 if $F: \catcw \morph \Fin$ is a functor which preserves designated monomorphisms
...
\begin{frame}{Assuming epi-mono splits}
\begin{itemize}
...
Tp proceed further \highlight{Remove this slide}
\begin{itemize}
...
\begin{frame}{Tellingly...}\highlight{Remove this slide}
We can show that if
