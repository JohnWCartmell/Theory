...
\input{../content/chemistryData/definitions.tex}
\begin{frame}{Chemical Element Data}
\begin{center}
\scalebox{0.75}{\input{../content/chemistrydata/element.nonormalform.display.tabular}}
\hspace{0.5cm}
\onslide<2->{\scalebox{0.75}{\input{../content/chemistryData/allotropenonnormalform}}} 
\end{center}
\begin{itemize}
...
\scalebox{0.9}{
\input{../content/chemistryData/allotropenonnormalform}
} 
\end{frame}
\fi
...
\scalebox{0.9}{
\input{../content/chemistryData/chemicalElementGraphVariant}
} 
\end{frame}
