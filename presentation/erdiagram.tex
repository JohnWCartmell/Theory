...
{
\ifthenelse{\equal{#5}{1}}
{\only#7{\psline[linewidth=0.9pt,linearc=.05]{-}(#1,#2)(#3,#4)}}
{\only#7{\psline[linewidth=0.9pt,linearc=.05,linestyle=dashed,dash=2pt 2pt]{-}(#1,#2)(#3,#4)}}
}
}
...
% \ercrowfoot {#1 x0} {#2 y0} {#3 x11} {#4 y11} {#5 x12} {#6 y12} {#7 x13} {#8 y13} 
% 18 feb 2019 previously #9 was whether constructed relationship: 0|1
\newcommand<> {\ercrowfoot}[8]
{
\only#9{\psline[linewidth=0.9pt,linearc=.05]{-}(#1,#2)(#3,#4)}
\only#9{\psline[linewidth=0.9pt,linearc=.05]{-}(#1,#2)(#5,#6)}
\only#9{\psline[linewidth=0.9pt,linearc=.05]{-}(#1,#2)(#7,#8)}
}

\newcommand<> {\ercrowfootconstructed}[8]
{
\only#9{\psline[linewidth=1.5pt,linearc=.05,linecolor=lightgray]{-}(#1,#2)(#3,#4)}
\only#9{\psline[linewidth=1.5pt,linearc=.05,linecolor=lightgray]{-}(#1,#2)(#5,#6)}
\only#9{\psline[linewidth=1.5pt,linearc=.05,linecolor=lightgray]{-}(#1,#2)(#7,#8)}
}
